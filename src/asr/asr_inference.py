...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="The device to run the pipeline on. -1 for CPU (default), \
            0 for the first GPU and so on.",
        )
    parser.add_argument(
        "--batch_size",
        type=int,
    ...
    parser.add_argument(
        ...
        help="Number of samples to be evaluated. \
            Put a lower number e.g. 64 for testing this script.",
        )
    parser.add_argument(
        "--language",
        type=str,
